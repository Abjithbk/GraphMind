...
export const CustomNode = ({data,selected}:NodeProps & {data: CustomNodeData}) => {
  ...
  return (
    <motion.div
      ...
      className={`px-4 py-3 border shadow-xl backdrop-blur-md flex items-center gap-3 rounded-xl transition-all ${bgClass} ${selected ? 'ring-2 ring-primary scale-105' : ''}`}
    >
